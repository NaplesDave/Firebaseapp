...
class PhoneActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        phoneBinding.buttonSendSMSCode.setOnClickListener {
            ...
            val userPhoneNumber =
                phoneBinding.editTextPhoneNumber.text.toString()
        ...
        mCallbacks = object : PhoneAuthProvider
    ...
    fun signinWithSMSCode(){
        // get the user entered code from the screen
        val userEnterCode = phoneBinding.editTextVerificationCode.text.toString()

        // check the user code with the sent code with Firebase
    ...
    fun signinWithPhoneAuthCredential(credential: PhoneAuthCredential){
        ...
        auth.signInWithCredential(credential).addOnCompleteListener { task ->
            ...
            if (task.isSuccessful){
                ...
                Toast.makeText(applicationContext, "The code you entered is " +
